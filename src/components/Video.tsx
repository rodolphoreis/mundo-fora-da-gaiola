...
const Video = () => {
  return (
    <div className="bg-customGreen py-10 w-full">
      <Transition className=" sm:py-8  md:px-16 flex flex-col sm:grid sm:grid-cols-[2fr,2fr] max-w-[1200px] mx-auto gap-5 sm:gap-20">
