        ...
        <Transition>
          ...
          <div className="flex flex-col sm:grid sm:grid-cols-[1fr,3fr] max-w-[1200px] mx-auto text-center space-y-3 mt-16 md:mt-32">
            <div className=" p-5 space-y-6">
              ...
              <Link href="/sign-in">
                <Button className="rounded-full bg-[#4FA81F] hover:bg-slate-100 hover:text-[#4FA81F] text-white border-[3px] border-white hover:border-[#4FA81F] px-16 md:px-6 py-7 font-bold text-base -tracking-tighter mt-10 md:w-full">
                  EU QUERO SER LIVRE
                </Button>
              </Link>
            </div>
